...
//
// This is declared as a variable rather than a function so goimportz can
...
// A Resolver does the build-system-specific parts of goimportz.
...
func pkgIsCandidate(filename string, refs references, pkg *pkg) bool {
	...
	// anyway. There's no reason goimportz needs
